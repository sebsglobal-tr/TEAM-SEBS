  ...
  return (
    <div>
      <div className="page-header">
        ...
        <p className="page-subtitle">Sistemdeki tüm çalışan raporlarını görüntüleyin ve değerlendirin</p>
      </div>
          ...
          {reports.map((report) => (
            <div className="card" key={report.id}>
              <div className="card-body">
                ...
                {report.description && (
                  <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', marginBottom: '0.75rem' }}>{report.description}</p>
                )}
                ...
                <div style={{ display: 'flex', gap: '0.5rem' }}>
                  <input
                    ...
                    style={{ flex: 1 }}
                    placeholder="Onay/revize notu ekleyin..."
